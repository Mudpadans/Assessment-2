...
function canWeDeliver(zipCode) {
    ...
    if (deliveryAreaZipCodes.includes(zipCode)) {
        ...
        delivery = "Sorry, we can't deliver to that address";
        }
...
//CODE HERE
var firstDeal = deals.shift();
firstDeal.title = firstDeal.title.replace('15','10');
deals.unshift(firstDeal);
//console.log(deals);
...
//CODE HERE
var secondDeal = deals.pop();
secondDeal.desc = secondDeal.desc.replace('March', 'April');
secondDeal.desc = secondDeal.desc.trim();
deals.push(secondDeal);
console.log(deals)